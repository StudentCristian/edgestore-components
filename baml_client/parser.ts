  ...
  ExecuteWebSearch(
    ...
    try {
      ...
      return this.runtime.parseLlmResponse(
        ...
        __baml_options__?.clientRegistry,
        env,
      ) as partial_types.WebSearchTool
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  ProcessForm(
    ...
    try {
      ...
      return this.runtime.parseLlmResponse(
        ...
        __baml_options__?.clientRegistry,
        env,
      ) as partial_types.DynamicFields
    } catch (error) {
      throw toBamlError(error);
    }
  }
